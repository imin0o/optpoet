...
- [x] **P0-015** 2,000 / 5,000 セルの画像処理・描画メモリ使用量を測定する。→ [memory-usage.md](../environment/memory-usage.md)
- [x] **P0-016** 形態素解析器の候補を比較し、辞書配布条件と未知語挙動を確認する。→ [morphological-analyzer.md](../environment/morphological-analyzer.md)
- [x] **P0-017** ローカル UI 候補を比較し、loopback 固定・取消・進捗表示を確認する。→ [local-ui.md](../environment/local-ui.md)
